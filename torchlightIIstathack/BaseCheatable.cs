...
namespace torchlightIIstathack
{
    public class BaseCheatable
    {
        ...
        public BaseCheatable(string ProcessName)
        {
            try
            {
            ...
            {
                System.Windows.Forms.MessageBox.Show("Failed to detect TorchlightII process. Please make sure Torchlight is running and try again.");
                Environment.Exit(0);
            }
        }
